            ...
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    'data-[disabled]:bg-muted-foreground data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground bg-[#0984e3] p-2',
                  ...
                  <button
                    ...
                    <X className='h-4 w-4 text-white hover:text-[#0984e3]' />
                  </button>
                </Badge>
              );
            })}
